...
public class AlohandesTransactionManager 
{
	...
	public void addCliente(Cliente c) throws SQLException, Exception
	{
		try {
			...
			{
				System.err.println("[EXCEPTION] Logic Exception:" + "Es necesario que envie un documento que demustre su relaciÃ³n con la universidad.");
				throw new Exception("Es necesario que envie un documento que demustre su relaciÃ³n con la universidad.");
			}
		} catch (Exception e) {
			System.err.println("[EXCEPTION] General Exception: " + "El correo no tiene un formato vÃ¡lido");
			throw new Exception("El correo no tiene un formato vÃ¡lido");
		}
		DAOJoins joins = new DAOJoins( );
