...
public class DAOAlojamiento 
{
	...
	{
		String sql = String.format("UPDATE %1$s.ALOJAMIENTOS SET OCUPADA = '1' WHERE ID = %2$s", USUARIO, id);
		System.out.println(sql);
	...
	{
		String sql = String.format("UPDATE %1$s.ALOJAMIENTOS SET OCUPADA = '0' WHERE ID = %2$s", USUARIO, id);
		System.out.println(sql);
