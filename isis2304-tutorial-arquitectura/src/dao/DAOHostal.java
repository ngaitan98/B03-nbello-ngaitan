...
public class DAOHostal
{
	 ...
	 * </br>
	 * @param hostal hotal que se desea ingresar 
	 ...
	 * </br>
	 * @param id id del hostal del cual se quiere obtener la informacion
	 * @return un ResultSet que contiene la informacion del hostal que cumple los criterios de la sentencia SQL
	 ...
	 * </br>
	 * @param id Id del hostal que se desea eliminar
